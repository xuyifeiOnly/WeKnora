<template>
  <div class="login-layout">
    ...
    <!-- Logo - Top Left -->
    <a href="https://rutang.cn/" target="_blank" class="header-logo" :title="$t('common.website')">
      <img src="@/assets/img/rutang-logo.svg" alt="如棠科技" class="logo-image" />
    </a>

    <!-- Header Links - Top Right -->
    <div class="header-links">
      <a href="https://rutang.cn/" target="_blank" class="header-link" :title="$t('common.website')">
